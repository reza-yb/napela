...
class Profile(models.Model):
    ...
    entrance_year = models.IntegerField(verbose_name=_('entrance year'))
    phone_number = models.CharField(verbose_name=_('phone number'), max_length=20, null=False, blank=True, default='')
